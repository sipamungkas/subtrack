...
vibrant neon green (approx #39FF14) to teal (#14B8A6). The design should convey a
...
suggesting a gentle push or reminder. Use a vibrant neon green-to-teal gradient
...
neon green primary with teal (#14B8A6) accent for the wave.
...
Gradient background from neon green to teal or emerald.
...
abstract and minimal. Use a modern gradient: neon green to teal.
...
| Color              | Value (Approx)          | Usage                               |
| ------------------ | ----------------------- | ----------------------------------- |
| Primary Neon Green | `oklch(0.87 0.29 142)`  | Main brand color (Vibrant Green)    |
| Gradient End       | `Teal-500` (#14B8A6)    | Gradient flow                       |
| Gradient Mid       | `Emerald-400` (#34D399) | Gradient middle                     |
| Background Dark    | `oklch(0.145 0 0)`      | Dark mode background (Almost Black) |
...
- Colors: Neon Green to Teal gradient
...
Similar aesthetic to: Mint, YNAB, Rocket Money, but with a unique "nudge" identity. Using the neon green to stand out.
```
...
"Sub" in Neon Green, "nudge" in white or light gray (since dark mode is default).
...
- **Colors**: Neon Green gradient as primary, Teal as secondary
